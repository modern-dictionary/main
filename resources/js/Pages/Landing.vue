...
<template>
    ...
    >
        <img
            id="background"
            :class="['fixed inset-0 w-full h-full object-cover opacity-10 transition-opacity duration-500', { '!hidden': backgroundHidden }]"
                ...
                <header class="grid grid-cols-1 items-center gap-4 py-6 sm:py-10 lg:grid-cols-3">
                    ...
                    >
                        <Link
                            ...
                            class="border border-gray-700 rounded-md px-3 py-2 text-white ring-1 ring-transparent transition-all duration-300 hover:bg-white/10 hover:scale-105 focus:outline-none focus-visible:ring-[#FF2D20] shadow-lg hover:shadow-[#FF2D20]/20"
                        >
                            داشبورد
                        </Link>

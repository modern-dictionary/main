        ...
        <form @submit.prevent="submit" dir='rtl'>
            <div>
                ...
                <TextInput
                    ...
                    v-model="form.name"
                    type="text"
                    class="mt-1 block w-full text-white bg-gray-800 rounded-lg transform transition-all duration-300 hover:ring-white/20 hover:shadow-xl hover:shadow-[#FF2D20]/10 hover:bg-gray-700/50 translate-y-0 hover:-translate-y-1"
                    required
                    autofocus
                    autocomplete="name"
                />

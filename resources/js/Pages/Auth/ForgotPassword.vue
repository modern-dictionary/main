    ...
    <div class="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen">
        ...
        <div class="relative min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4">
                <div class="flex flex-col gap-6 overflow-hidden rounded-lg bg-gradient-to-br from-gray-800/50 to-gray-700/50 p-6 shadow-lg ring-1 ring-white/10 transition duration-300 hover:ring-white/20 hover:shadow-xl hover:shadow-[#FF2D20]/10 backdrop-blur-sm">
                    <div class="text-sm text-white/70" dir="rtl">
                        رمز عبور خود را فراموش کرده‌اید؟ مشکلی نیست. فقط آدرس ایمیل خود را به ما اطلاع دهید و ما یک لینک بازنشانی رمز عبور برای شما ارسال خواهیم کرد که به شما امکان می‌دهد رمز جدیدی را انتخاب کنید.
                    </div>
                    ...
                    <form @submit.prevent="submit" dir="rtl" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <PrimaryButton
                                ...
                                class="bg-[#FF2D20] hover:bg-[#FF2D20]/90 hover:scale-105 hover:ring-white/20 hover:shadow-xl hover:shadow-[#FF2D20]/10 transition duration-300"
                            >
                                <span class="text-black">ارسال لینک بازنشانی رمز عبور</span>
                            </PrimaryButton>
                        </div>
                    </form>
                </div>
